...
for ticker in tickers:
    ...
    start = datetime.datetime(2012,4,25) #"1992-04-25"
    ...
    while(hours_between > 0):
        ...
        url = 'https://www.bitmex.com/api/v1/funding?symbol='+ticker+'&count='+str(max_count)+'&reverse=false&endTime='+end.strftime("%Y-%m-%d")
